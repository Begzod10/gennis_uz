...
Revision ID: 9151698ae1d5
Revises: 
Create Date: 2022-07-03 23:42:33.965042
...
def upgrade():
    ...
    op.create_table('accountingperiod',
...
def downgrade():
    ...
    op.drop_table('accountingperiod')
    # ### end Alembic commands ###
