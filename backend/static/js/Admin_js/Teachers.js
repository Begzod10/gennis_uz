window.addEventListener('DOMContentLoaded',()=> {
    ...
    radio_name.addEventListener('click',()=>{
        ...
        search_input.name = 'teacher_name'
        search_form.action = "/teacher_search_name"
    })
    radio_surname.addEventListener('change',()=>{
        search_input.placeholder = "Введите фамилию";
        search_input.name = 'teacher_surname'
        search_form.action = "/teacher_search_surname";
    })
    radio_username.addEventListener('click',()=>{
        search_input.placeholder = "Введите имя пользователя";
        search_input.name = 'teacher_username'
        search_form.action = "/teacher_search_username"
    })
